...
<div class="container mt-5">
	<h1 class="d-flex align-items-center justify-content-center text-primary">Project Manager</h1>
	<p class="d-flex align-items-center justify-content-center">A place for teams to manage projects.</p>
	<div class="row">
	<div class="col-6">
		<h3>Register</h3>
